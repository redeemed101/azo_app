...
class MyProgressBar : ProgressBar {
    ...
    constructor(context: Context, index: Int, durationInSeconds: Int, timeWatcher: ProgressTimeWatcher, @DrawableRes mProgressDrawable : Int = R.drawable.green_lightgray_drawable ) : super(
        context,
        null,
        0,
